...
export const proshopPhotos = [
  ...
  { src: '/images/proshop/hats-caps-display.jpg', alt: 'Hats and caps display, TaylorMade and GolfCube branded' },
...
export const learningSteps = [
  { step: 1, title: 'Putting & Chipping', desc: 'Start with the short game to build feel, touch, and confidence around the green.' },
...
export const products = [
  { title: 'Hats & Caps', price_label: 'From $30', description: 'TaylorMade, GolfCube Social branded caps, and more. Multiple styles and colors available.', image: '/images/proshop/hats-caps-display.jpg', image_alt: 'Golf caps and hats display, TaylorMade and GolfCube branded' },
